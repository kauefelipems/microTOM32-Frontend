...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC0     ------> ADC1_IN6
    */
    HAL_GPIO_DeInit(I_P_GPIO_Port, I_P_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC3     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(I_N_GPIO_Port, I_N_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PD13     ------> ADC3_IN10
    */
    HAL_GPIO_DeInit(GPIOD, VMEAS_N_Pin|VMEAS_P_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, PGA_DB_Pin|PGA_LIN_Pin);
